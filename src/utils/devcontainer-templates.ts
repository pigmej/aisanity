  ...
  const devcontainerJson = JSON.stringify(
    {
      ...
      customizations: {
        vscode: {
          extensions: ["ms-vscode.vscode-typescript-next", "ms-vscode.vscode-json", "oven.bun-vscode"],
        },
      },
      forwardPorts: [3000, 3001],
      mounts: [
  ...
  const devcontainerJson = JSON.stringify(
    {
      ...
      customizations: {
        vscode: {
          extensions: ["golang.Go", "ms-vscode.vscode-json", "ms-vscode.vscode-yaml"],
        },
      },
      forwardPorts: [8080],
      mounts: [
  ...
  const devcontainerJson = JSON.stringify(
    {
      ...
      customizations: {
        vscode: {
          extensions: ["rust-lang.rust-analyzer", "ms-vscode.vscode-json", "ms-vscode.vscode-yaml"],
        },
      },
      forwardPorts: [8080],
      mounts: [
  ...
  const devcontainerJson = JSON.stringify(
    {
      ...
      customizations: {
        vscode: {
          extensions: ["vscjava.vscode-java-pack", "ms-vscode.vscode-json", "ms-vscode.vscode-yaml"],
        },
      },
      forwardPorts: [8080],
      mounts: [
  ...
  const devcontainerJson = JSON.stringify(
    {
      ...
      customizations: {
        vscode: {
          extensions: ["ms-vscode.vscode-json", "ms-vscode.vscode-yaml"],
        },
      },
      forwardPorts: [],
      mounts: [
